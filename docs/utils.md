各种Go框架、工具：[awesome-go](https://github.com/avelino/awesome-go)
## 开发所用库
...
4. Mock框架 [gomock](https://github.com/golang/mock) /[testify/mock](https://github.com/stretchr/testify )/ [goconvey](https://github.com/smartystreets/goconvey )
